...
RUN dotnet publish "simpli.Api.csproj" -c Release -o /app/publish /p:UseAppHost=false /p:OpenApiGenerateDocumentsOnBuild=false /p:OpenApiIncludeXmlComments=false /p:OpenApiEnableSourceGenerator=false
